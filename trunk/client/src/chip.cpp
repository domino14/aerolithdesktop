...
void Chip::paint(QPainter *painter, const QStyleOptionGraphicsItem *item, QWidget *widget)
{
	...
	if (numberMode)
	  {
		...
		foregroundPen = QPen(Qt::black);
		edgePen = QPen(QColor(255, 0, 0).darker(200), 0);
		break;
	      case 2:
		...
		chipBrush = QBrush(linearGrad);
		foregroundPen = QPen(Qt::black);
		edgePen = QPen(QColor(0, 0, 255).darker(200), 0);
		break;
	      case 3:
		...
		chipBrush = QBrush(linearGrad);
		foregroundPen = QPen(Qt::black);
		edgePen = QPen(QColor(205, 155, 29).darker(200), 0);
		break;
	      case 4:
		...
		chipBrush = QBrush(linearGrad);
		foregroundPen = QPen(Qt::black);
		edgePen = QPen(QColor(205, 179, 139).darker(200), 0);
		break;
	      case 5:
		...
		chipBrush = QBrush(linearGrad);
		foregroundPen = QPen(Qt::black);
		edgePen = QPen(QColor(139, 69, 19).darker(200), 0);
		break;
	      case 6:
		...
		chipBrush = QBrush(linearGrad);
		foregroundPen = QPen(Qt::black);
		edgePen = QPen(QColor(255, 99, 71).darker(200), 0);
		break;
	      case 7:
		...
		chipBrush = QBrush(linearGrad);
		foregroundPen = QPen(Qt::black);
		edgePen = QPen(QColor(124, 205, 124).darker(200), 0);
		break;
	      case 8:
		...
		chipBrush = QBrush(linearGrad);
		foregroundPen = QPen(Qt::black);
		edgePen = QPen(QColor(102, 205, 170).darker(200), 0);
		break;
	      case 9:
		...
		edgePen = QPen(QColor(85, 26, 139).darker(200), 0);
		break;
	      default:
		...
		chipBrush = QBrush(linearGrad);
		foregroundPen = QPen(Qt::white);
		edgePen = QPen(QColor(41, 36, 33), 0);
	...
	painter->drawArc(QRectF(0.0, 0.0, 19.0, 19.0), 0.0, -150*16);
	// Draw text
